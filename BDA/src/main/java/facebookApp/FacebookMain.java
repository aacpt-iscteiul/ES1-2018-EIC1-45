...
public class FacebookMain {
	...
	/**
	 * Used mostly for debug or to get the entire User (Class User from library
	 * restFB) Useful to see potential fields available.
	 * 
	 * @return User object
	 */
	public User getMe() {
	...
	/**
	 * getPosts() - Used to get all the posts in the page. Due to recent limitations
	 * on the API can only get "me" - Trying to find a solution, but there doesn't
	 * seem to be one with this API.
	 * 
	 ...
	 * 
	 * List<Post> page = result; return page; }
	 * 
	 */

	/**
	 * 
	 * Method to print what's being obtained from the current fetchConnection
	 * command. Printing to console - Currently being used to 'debug'/test the API
	 * and token access.
	 * 
	 */
	/*
	 ...
	 * 
	 * Connection<Post> result = fbClient.fetchConnection("me/feed",Post.class);
	 * System.out.println("\nPosts:"); int counter5 = 0; int counterTotal = 0;
	 * 
	 * for (List<Post> page : result) {
	 * 
	 * for (Post aPost : page) { // Filters for posts. --- Many possibilities if
	 * (aPost.getLikesCount()>=0) {
	 * 
	 ...
	 * counter5+"/"+counterTotal);
	 * 
	 * // Test Below /*System.out.println("Username:"+me.getId()); unsigned int a =
	 * Integer.parseInt(me.getId()); System.out.println("a"+a);
	 * 
	 * 
	 * }
	 */
...
//	public static void main(String[] args) {	
	 ...
	 * https://www.youtube.com/watch?v=wiFif4gOdFE&index=6&list=
